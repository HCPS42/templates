...
struct Vec {
    ...
    friend Vec operator-(Vec a, const Vec& b) { return a -= b; }
    friend Vec operator*(Vec a, const T& b) { return a *= b; }
    friend Vec operator*(const T& a, Vec b) { return b *= a; }
    friend Vec operator/(Vec a, const T& b) { return a /= b; }
    friend bool operator==(const Vec& a, const Vec& b) { return a.a == b.a; }
